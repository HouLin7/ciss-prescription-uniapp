...
<script lang="ts">
	import { ApplyRecordItem, UserInfo } from '../../common/data-model';
	...
	export default {
		...
		methods: {
			...
			isSelect(value) {
				for (var item of this.selectSportValues) {
					if (item == value) {
						return true;
					}
				}
			...
			checkboxChange(e) {
				...
				this.selectSportValues = e.detail.value;
			},
		},
		computed: {
			bodyHeight() {
